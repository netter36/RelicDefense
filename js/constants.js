...
export const MONSTER_TYPES = [
    { id: 'slime', name: '슬라임', hp: 80, speed: 0.001, color: 0x10b981, size: 40 },
    { id: 'guardian', name: '가디언', hp: 300, speed: 0.0004, color: 0x6366f1, size: 55 },
    { id: 'spirit', name: '영혼', hp: 120, speed: 0.0012, color: 0xd8b4fe, size: 30 },
    { id: 'golem', name: '골렘', hp: 600, speed: 0.0002, color: 0x71717a, size: 70 }
];
