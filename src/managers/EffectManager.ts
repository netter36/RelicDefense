...
export class EffectManager {
    ...
    showDamageText(x: number, y: number, damage: number, isCrit: boolean) {
    ...
    showGoldText(x: number, y: number, amount: number) {
    ...
    createExplosion(x: number, y: number, radius: number, color: number = 0xffaa00) {
    ...
    drawLaser(startX: number, startY: number, endX: number, endY: number, color: number, width: number = 4, alpha: number = 1) {
    ...
    drawNova(x: number, y: number, radius: number, color: number = 0x3b82f6) {
    ...
    drawBeam(startX: number, startY: number, range: number, angle: number, coneAngle: number, color: number) {
